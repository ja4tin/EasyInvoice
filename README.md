...
*   **📦 电子归档 (ZIP Export)**: 一键将画布上的发票源文件（图片/PDF）连同生成的标准 PDF 打包下载，文件自动规范命名 (如 `invoice_差旅费_500.jpg`)，方便归档报销。
*   **📱 局域网传图 (P2P WebRTC)**: 无需借助微信文件传输助手，电脑浏览器生成二维码，手机原生相机扫码即刻建立内网点对点的高速连接，快速传输照片和 PDF 发票到排版画布，体验无缝的跨端协作。
